...
void progress_init(struct progress_bar *prog, int start, unsigned long long stop, unsigned long long total, int flag, int size)
{
...
int open_pui(int pui, unsigned long res)
{
    int tui = 0;
    if (pui == NCURSES)
    {
...
void update_pui(struct progress_bar *prog, unsigned long long copied, unsigned long long current, int done)
{
...
void progress_update(struct progress_bar *prog, unsigned long long copied, unsigned long long current, int done)
{
    char clear_buf = ' ';
...
void Ncurses_progress_update(struct progress_bar *prog, unsigned long long copied, unsigned long long current, int done)
{
#ifdef HAVE_LIBNCURSESW
