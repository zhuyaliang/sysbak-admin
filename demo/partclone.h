...
void log_mesg(int lerrno, int lexit, int only_debug, int debug, const char *fmt, ...);
void close_log();
int io_all(int *fd, char *buffer, guint64 count, int do_write, cmd_opt *opt);
